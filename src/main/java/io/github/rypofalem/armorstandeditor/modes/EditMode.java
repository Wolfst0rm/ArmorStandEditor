...
public enum EditMode {
    ...
    PLACEMENT("Placement"), INVULNERABLE("Invulnerable"), DISABLESLOTS("DisableSlots"), ROTATE("Rotate"), EQUIPMENT("Equipment"), RESET("Reset"), ITEMFRAME("ItemFrame"), ITEMFRAMEGLOW("ItemFrameGlow");
